/*
  # Add Email Support for Cold Outreach System

  1. Database Schema Updates
    - Update channel types to include email
    - Update sequence types to include email
    - Add email-specific fields to conversation history
    - Add email templates and subjects to campaign sequences

  2. New Features
    - Email channel configuration for GSuite
    - Email sequence steps in campaign builder
    - Email tracking and analytics
    - Email template management

  3. Security
    - RLS policies updated for email data
    - Proper validation for email fields
*/
